...
This guide covers Elastisch 2.0.x releases, including preview
releases.
...
``` clojure
(clojurewerkz.elastisch.rest.index/update-aliases conn [{:add {:index "client0000001" :alias "alias1"}}
                                                        {:add {:index "client0000002" :alias "alias2"}}])

(clojurewerkz.elastisch.rest.index/get-aliases conn "client0000001")
```
